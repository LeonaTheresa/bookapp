...
SECRET_KEY = 'django-insecure-d&#0evb^c2$1ari8#(%%81rg#wdwr!@cbmcmv08^jap)el##h5'
...
# bookcollection/settings.py

# settings.py

# REST_FRAMEWORK = {
#     'DEFAULT_FILTER_BACKENDS': ['rest_framework.filters.OrderingFilter', 'rest_framework.filters.SearchFilter'],
#     'DEFAULT_PERMISSION_CLASSES': ['rest_framework.permissions.IsAuthenticated'],  # Optional
# }
